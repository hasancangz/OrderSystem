...
{
    internal class DecreasingStock:BaseAction
    {
        OrderService orderService;
        ManagerService managerService;
        HelperStock helperStock;

        public DecreasingStock(OrderService orderService,ManagerService managerService,HelperStock help)
        {
        ...
        public override ActionStatus OnExecute()
        {
            ...
            var result=managerService.DecreasingProduct(dict);
